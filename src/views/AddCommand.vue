    ...
    <a-form style="width: 100%; height: 100%">
      ...
      <div class="command-arg">
        <div class="command-arg-content">
          <!-- <div class="command-arg-content-header"> -->
          <!--   <span style="height: 30px; flex: 3; text-align: center; border-radius: 4px">分隔符</span> -->
          <!--   <span style="height: 30px; flex: 4; text-align: center; border-radius: 4px">参数</span> -->
          <!--   <span style="height: 30px; flex: 4; text-align: center; border-radius: 4px">单词</span> -->
          <!--   <span style="height: 30px; flex: 10; text-align: center; border-radius: 4px">描述</span> -->
          <!-- </div> -->
          <a-table
            :columns="argHeader"
            :dataSource="argData"
